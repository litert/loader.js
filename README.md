...
Recommended: https://cdn.jsdelivr.net/npm/@litert/loader@3.5.5/dist/loader.min.js, you can also find it here https://cdn.jsdelivr.net/npm/@litert/loader/.

Also available on [unpkg](https://unpkg.com/@litert/loader@3.5.5/dist/loader.min.js).
...
```html
<script src="https://cdn.jsdelivr.net/npm/@litert/loader@3.5.5/dist/loader.min.js"></script>
```
...
```html
<script src="https://cdn.jsdelivr.net/npm/@litert/loader@3.5.5/dist/index.min.js?path=../lib/test"></script>
```

Use the ?cdn= parameter to set the source address of the third library load, default is: https://cdn.jsdelivr.net.

```html
<script src="https://cdn.jsdelivr.net/npm/@litert/loader@3.5.5/dist/index.min.js?cdn=https://cdn.xxx.xxx"></script>
```
...
```html
<script src="https://cdn.jsdelivr.net/npm/@litert/loader@3.5.5/dist/index.min.js?&path=xxx&map={'xxx':'https://xx/npm/index'}"></script>
```
...
```html
<script src="https://cdn.jsdelivr.net/npm/@litert/loader@3.5.5/dist/index.min.js?&path=xxx&npm={'xxx':'1.0.0'}"></script>
```
