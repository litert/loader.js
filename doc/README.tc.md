...
推薦引用位址：https://cdn.jsdelivr.net/npm/@litert/loader@3.5.6/dist/index.min.js，也可以此處查找：https://cdn.jsdelivr.net/npm/@litert/loader/。

同樣可使用 [unpkg](https://unpkg.com/@litert/loader@3.5.6/dist/index.min.js)。
...
```html
<script src="https://cdn.jsdelivr.net/npm/@litert/loader@3.5.6/dist/index.min.js"></script>
```
