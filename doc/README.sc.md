...
推荐引用地址：https://cdn.jsdelivr.net/npm/@litert/loader@3.5.6/dist/index.min.js，也可以此处查找：https://cdn.jsdelivr.net/npm/@litert/loader/。

同样可使用 [unpkg](https://unpkg.com/@litert/loader@3.5.6/dist/index.min.js)。
