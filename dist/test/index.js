...
tool.onClick('btn-extract-string', () => {
    const res = loader.tool.extractString(loader.tool.removeComment(document.getElementById('extractString1').value));
    document.getElementById('extractString2').value = res.code;
